...
/**
 * Created by CPR161 on 2017-03-09.
 */
...
//            .buildProcessEngine();
        ...
        List<Task> tasks = taskService.createTaskQuery().taskCandidateGroup("marketing").list();
        for (Task task : tasks) {
            System.out.println("Following task is available for marketing group: " + task.getName());
